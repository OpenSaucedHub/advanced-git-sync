...
#
# Options:
#   --repo <url>   Override the target repository URL (default: https://github.com/OpenSaucedHub/advanced-git-sync.git)
#
...
DEFAULT_TARGET_REPO="https://github.com/OpenSaucedHub/advanced-git-sync.git"
